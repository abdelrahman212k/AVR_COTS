...
#define PORTB_PIN3_INITIAL_VAL      LOW
#define PORTB_PIN4_INITIAL_VAL      LOW
#define PORTB_PIN5_INITIAL_VAL      LOW
#define PORTB_PIN6_INITIAL_VAL      LOW
#define PORTB_PIN7_INITIAL_VAL      LOW
...
#define PORTC_PIN4_INITIAL_VAL      LOW
#define PORTC_PIN5_INITIAL_VAL      LOW
#define PORTC_PIN6_INITIAL_VAL      LOW
#define PORTC_PIN7_INITIAL_VAL      LOW
...
#define PORTD_PIN4_INITIAL_VAL      PULL_UP
#define PORTD_PIN5_INITIAL_VAL      PULL_UP
#define PORTD_PIN6_INITIAL_VAL      PULL_UP
#define PORTD_PIN7_INITIAL_VAL      PULL_UP
